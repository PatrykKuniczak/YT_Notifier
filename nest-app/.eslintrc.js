module.exports = {
  ...
  plugins: ['@typescript-eslint/eslint-plugin', '@darraghor/nestjs-typed', 'prettier'],
  // PRETTIER MUST BE LAST
  extends: ['plugin:@typescript-eslint/recommended', 'plugin:@darraghor/nestjs-typed/recommended', 'prettier'],
  root: true,
  env: {
    node: true,
    jest: true,
