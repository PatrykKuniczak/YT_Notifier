...
const StyledGitHubLinkStyles = styled('a')(({ theme }) =>
  theme.unstable_sx({
    position: 'fixed',
    bottom: 0,
    left: 0,
...
const StyledGitHubLinkBackground = styled('path')(({ theme }) =>
  theme.unstable_sx({
    filter: `${theme.palette.background.gitHubIconBackgroundFilter}`,
  }),
);

export const StyledGitHubLink = () => (
  <StyledGitHubLinkStyles href={GITHUB_ISSUE_LINK} target={'_blank'}>
    <svg style={{ rotate: '180deg' }} viewBox="0 0 250 250">
      <StyledGitHubLinkBackground d="M0 0L115 115L127 127L142 142L250 250V0H0Z" />
